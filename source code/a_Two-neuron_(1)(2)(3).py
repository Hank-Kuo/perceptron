...
if __name__ == '__main__':
    ...
    training_data = pd.read_csv('training_data.txt', sep=' ', names=[
                                "shape", "texture", "weight", "Class"])
    testing_data = pd.read_csv('testing_data.txt', sep=' ', names=[
    ...
    # Train two neuron Perceptron Model with two component -- Dataset 1
    perceptron = Perceptron(nueron_size=2,component_size=2,transfer_target=dataset1_group_2)
    perceptron.W = np.array([[1, 0], [0, 1]])
    perceptron.B = np.array([[1], [1]])
    perceptron.labels = [1, 2, 3, 4]
    print("(a)Two-neuron perceptron: (1)Dataset 1")
    print("------------------------------------------------------")
    print("Initial")
    print("Weight:")
    print(perceptron.W)
    ...
    # Train two neuron Perceptron Model with two component -- Dataset 2
    perceptron1 = Perceptron(nueron_size=2,component_size=2,transfer_target=dataset2_group_2)
    print("(a)Two-neuron perceptron: (2)Dataset 2 – Use the first two components.")
    print("------------------------------------------------------")
    print("Initial")
    print("Weight:")
    print(perceptron1.W)
    ...
    # Train two neuron Perceptron Model with three component -- Dataset 2
    perceptron2 = Perceptron(nueron_size=2,component_size=3 , transfer_target=dataset2_group_2)
    print("(a)Two-neuron perceptron: (3)Dataset 2 – Use the three components.")
    print("------------------------------------------------------")
    print("Initial")
    print("Weight:")
    print(perceptron2.W)
